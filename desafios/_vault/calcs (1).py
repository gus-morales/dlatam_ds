...
def mutuouniversal(property_value, loan, nper, interest, property_type):
    ...
    The old code didn't include "kapital_table" in the dictionary, But it's calculated.
    Now it's added by "supertasa" credit
    """
    # rules
    """
...
def supertasa(property_value, loan, nper, interest_1, interest_2, property_type, first_periods=36):
    ...
    for keys in first_loan.build_development:
        first_loan.build_development[keys] = first_loan.build_development[keys][:first_periods] + \
                                             second_loan.build_development[keys]
...
loan = 1500
nper = 15 * 12
interest = Decimal(0.0249)
interest_2 = Decimal(0.0249)
grace = 0
property_type = "dpto"
...
#pprint(supertasa(property_value, loan, nper, interest, interest_2, property_type))
print(interest_2)